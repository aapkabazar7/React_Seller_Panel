    ...
    <div key={index} style={{ backgroundColor: "rgb(238 238 238 / 49%)", padding: 10, borderRadius: 10, width: "100%", alignItems: "center" }}>
        ...
        <div style={{ flex: 0.8, flexDirection: "row", display: "flex", alignItems: "center" }}>
          <div style={{ display: "flex", justifyContent: "center", alignItems: "center", gap: 20 }}>
            ...
            <div style={{ justifyContent: "center", alignItems: "center" }}>
              ...
              <input
                onChange={(e) => {
                  setData((prev) => ({ ...prev, deliveryCharges: Number(e.target.value) }));
                }}
                defaultValue={item._id.deliveryCharges}
                type="text"
                placeholder="₹ 0"
                style={{ border: "none", backgroundColor: "white", width: "20%", paddingLeft: 5, borderRadius: 8, textAlign: "center" }}
              />
            </div>
          </div>
          <div style={{ display: "flex", justifyContent: "center", alignItems: "center", gap: 20 }}>
            ...
            <div style={{ justifyContent: "center", alignItems: "center" }}>
              ...
              <input
                onChange={(e) => {
                  setData((prev) => ({ ...prev, minimumOrderValue: Number(e.target.value) }));
                }}
                type="text"
                defaultValue={item._id.minimumOrderValue}
                placeholder="₹ 0"
                style={{ border: "none", backgroundColor: "white", width: "20%", paddingLeft: 5, borderRadius: 8, textAlign: "center" }}
              />
            </div>
      ...
      <div style={{ flex: 1, display: "flex", flexDirection: "row" }}>
        <div style={{ flex: 1 }}>
          <textarea
            onChange={(e) => {
              setData((prev) => ({ ...prev, pincodes: e.target.value.split(",") }));
            }}
